...
namespace PersonalFinanceManager.Service.Data.Migrations
{
    ...
    [Migration("20210405122729_IdentitySchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalFinanceManager.Shared.Models.Statement", b =>
                {
                    ...
                    b.HasDiscriminator<string>("statement_type").IsComplete(true).HasValue("Statement");
                });
            ...
            modelBuilder.Entity("PersonalFinanceManager.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a60e35b4-2c02-43f1-aca9-958d6f9fc307",
            ...
            modelBuilder.Entity("PersonalFinanceManager.Shared.Models.IncomeModel", b =>
                {
                    b.HasBaseType("PersonalFinanceManager.Shared.Models.Statement");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("PersonalFinanceManager.Shared.Models.User", null)
                        .WithMany()
